    ...
    <script>
        ...
        this.on('mount', function(){
            ...
            $root.on('duplicate-entry', function(e, entry, parent) {
                ...
                var entries = (parent ? parent.children : $this.entries);               

                App.request('/collections/save_entry/'+$this.collection.name, {'entry': _entry, 'duplicated': true, 'entries': entries}).then(function(dupentry) {
