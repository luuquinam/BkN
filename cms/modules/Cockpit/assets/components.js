...
riot.tag2('cp-preloader-fullscreen', '<cp-preloader></cp-preloader>', 'cp-preloader-fullscreen { position: fixed; display: flex; top: 0; bottom: 0; left: 0; right: 0; align-items: center; justify-content: center; background: rgba(255, 255, 255, 0.5); z-index: 1000000000000000; }', '', function(opts) {
});
                ...
                App.assets.require(plugins, function() {
                    ...
                    setTimeout(function(){
                        ...
                        tinymce.init(App.$.extend(true, {
                            ...
                            resize: true,
                            height: 350,
                            menubar: 'edit insert view format table tools forecolor backcolor',
                            // textcolor_cols: "5",
                            toolbar: 'insertfile undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image editimage | forecolor backcolor | fontsizeselect ',
                            toolbar1: 'formatselect | bold italic strikethrough forecolor backcolor | link | alignleft aligncenter alignright alignjustify  | numlist bullist outdent indent  | removeformat | fontsizeselect | code',
                            fontsize_formats: '8px 9px 10px 11px 12px 13px 14px 15px 16px 17px 18px 19px 20px 21px 22px 23px 24px 36px 48px 72px',
                            // font_formats: "Arial=arial,helvetica,sans-serif;iCiel Uni Sans=iCiel Uni Sans;Helvetica Neue=Helvetica Neue;",
                            plugins: [
                                "print code preview fullpage powerpaste searchreplace autolink",
                                ...
                                "anchor toc insertdatetime advlist lists textcolor wordcount spellchecker",
                                "imagetools  contextmenu colorpicker textpattern help mediapath paste"
                            ],
                            image_advtab: true,
                            relative_urls: false
                        }, opts.editor || {}, {
